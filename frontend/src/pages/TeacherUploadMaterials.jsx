    ...
    >
      ...
      <header className="flex flex-wrap gap-3 justify-between items-center mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="glass-text-muted mt-1">Department: {teacherDepartment}</p>
          </div>
        </div>
        <div className="flex items-center gap-4">
          <ThemeToggle />
      ...
      <div className="glass-panel p-6 mb-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          {/* Material Type */}
          <div>
            <label className="block glass-text-muted font-semibold mb-3">
            ...
            <div className="flex gap-4">
              <label className="flex-1 cursor-pointer">
                ...
                <div className={`p-4 rounded-lg border-2 transition-all ${
                  uploadType === 'notes'
                    ...
                    : 'border-white/30 bg-white/40 dark:bg-white/5'
                }`}>
                  <i className="fas fa-book text-2xl mb-2 text-purple-500"></i>
                  <h3 className="font-semibold glass-text">Notes</h3>
                  <p className="text-sm glass-text-muted">Study notes and materials</p>
                </div>
              </label>
              ...
              <label className="flex-1 cursor-pointer">
                ...
                <div className={`p-4 rounded-lg border-2 transition-all ${
                  ...
                  <h3 className="font-semibold glass-text">Question Paper</h3>
                  <p className="text-sm glass-text-muted">Previous year papers</p>
                </div>
              </label>
            </div>
          </div>
          ...
          <button
            type="submit"
            disabled={uploading}
            className="w-full py-3 bg-purple-500 hover:bg-purple-600 text-white font-bold rounded-lg shadow-glass hover:shadow-glass-lg transform hover:-translate-y-1 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {uploading ? (
              <>
        ...
        {uploadedMaterials.length === 0 ? (
          ...
          <div className="space-y-3">
            {uploadedMaterials.map(material => (
              <div
                key={material.id}
                className="flex items-center justify-between p-4 bg-white/40 dark:bg-white/5 rounded-lg transition-all"
              >
