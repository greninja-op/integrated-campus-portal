  ...
  return (
    ...
    >
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-slate-300 dark:border-slate-600">
                  <th className="px-4 py-3 text-left glass-text-muted font-semibold">Teacher ID</th>
                  ...
                  <th className="px-4 py-3 text-left glass-text-muted font-semibold">Qualification</th>
              ...
              <tbody>
                {filteredTeachers.map((teacher, index) => (
                  <tr key={index} className="border-b border-slate-200 dark:border-slate-700 hover:bg-primary/5 transition-all">
                    <td className="px-4 py-3 glass-text">{teacher.teacher_id}</td>
                    <td className="px-4 py-3 glass-text">{teacher.full_name}</td>
                    <td className="px-4 py-3 glass-text">{teacher.department}</td>
                    <td className="px-4 py-3 glass-text">{teacher.qualification}</td>
      ...
      {showAddForm && (
        ...
        >
          <h2 className="text-2xl font-display font-bold glass-text mb-6">
            {isEditMode ? 'Edit Teacher' : 'Add New Teacher'}
          </h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            {/* Profile Photo Upload */}
            <div className="flex items-center gap-6 p-4 bg-emerald-500/5 rounded-lg md:col-span-2">
              <div>
                {imagePreview ? (
                  <img
                    src={imagePreview}
                  ...
                  <div className="w-24 h-24 rounded-full bg-primary/15 flex items-center justify-center text-primary text-3xl font-bold">
            ...
            <div>
              <label className="block glass-text-muted font-semibold mb-2">
                Assign Subjects <span className="glass-text-muted text-sm">(Select subjects this teacher will teach)</span>
              </label>
